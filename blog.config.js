...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '19ffafad7db94865b6093c0dec6fb60c',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '用文字记录我的世界🦄',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Laceの部落格', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '记录折腾的点点滴滴，只为给自己留下记忆。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://laceee.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '部落格,blog,博客', // 网站关键词 英文逗号隔开

...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'T-Lace', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '随心随手', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.baidu.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Lace', // 网站关键词 英文逗号隔开
